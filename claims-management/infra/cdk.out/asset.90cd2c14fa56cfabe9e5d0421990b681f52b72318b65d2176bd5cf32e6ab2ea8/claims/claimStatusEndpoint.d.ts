 ...
 */
export declare function buildClaimStatusResponse(claimId: string, currentStatus: ClaimStatus, statusHistory: StatusHistoryEntry[]): ClaimStatusResponse;
//# sourceMappingURL=claimStatusEndpoint.d.ts.map