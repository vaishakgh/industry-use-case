 ...
 */
export declare const DAMAGE_ASSESSMENT_PACKAGE_NAME = "@claims/damage-assessment";
...
export type { SinglePhotoAnalysis, RekognitionAnalysisClient, AggregatedAssessment, AssessmentOutcome, } from './analysisAggregation';
