 ...
 */
export declare const FRAUD_DETECTION_PACKAGE_NAME = "@claims/fraud-detection";
export * from './screening';
export * from './checks';
export { resolveFraudReview } from './resolveFraudReview';
export type { FraudAnalystDecision, ResolveFraudReviewInput, FraudReviewResolution, } from './resolveFraudReview';
