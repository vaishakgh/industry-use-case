...
export declare const CLAIMS_AUDIT_FAILURE_ERROR_NAME = "Claims.AuditFailure";
/**
 ...
 */
export declare class ClaimsAuditFailureError extends Error {
    readonly claimId: string;
    readonly cause?: unknown | undefined;
    constructor(claimId: string, cause?: unknown | undefined);
}
/**
 ...
 *   case.
 */
export declare function recordDecisionBeforeEffect(input: RecordAutomatedDecisionInput, repository: AuditLogRepository): Promise<AuditLogRecord>;
//# sourceMappingURL=recordDecisionBeforeEffect.d.ts.map